...
<body>
	...
	<div class ="container">
		<div class = "jumbotron">
			<div class ="container">
				<h1>WEB site 紹介</h1>
				<p>このWEBサイトはBootstrapで作ったJSP WEBサイトです。</p>
				<p>最小限の簡単なロジックを利用して開発しました。</p>
				<p>デザインテンプレートではBootstrap使いました。</p>
				<p><a class ="btn btn-primary btn-pull" href="#" role="button">詳しく調べる</a></p>
			</div>
		</div>
	</div>
	<div class ="container">
